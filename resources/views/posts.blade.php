        ...
        @foreach($posts as $post)
            <div class="card mb-3">
                ...
                <a href="/post/{{$post->slug}}" class="stretched-link"></a>
                    @if(!empty($post->thumbnail) && file_exists(storage_path('app/public/img/thumbnails/'.$post->thumbnail))) <div class="col-md-8"> @endif
                        <div class="card-body">
                    ...
                    @if(!empty($post->thumbnail) && file_exists(storage_path('app/public/img/thumbnails/'.$post->thumbnail))) </div> @endif
